...
holo = r"C:\Users\tom_p\OneDrive - Universidad EAFIT\Semestre X\TDG\Images\Holos\USAF\usaf_06.bmp"
idx = 1
...
xar = focusing.manual_focus(propagators[idx],focus_params[idx],0.4e-3,0.5e-3,11)
