...
# solution = propagator.autocall('convergentSAASM_pad',parameters)
solution = propagator.convergentSAASM_pad(*parameters)
...
# xar = focusing.manual_focus('convergentSAASM',focus_params,2.5e-3,3e-3,11)
