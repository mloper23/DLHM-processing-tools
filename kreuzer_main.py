...
holo = r"F:\OneDrive - Universidad EAFIT\Semestre X\TDG\Images\Holos\USAF\usaf_02.bmp"
wvl = 411e-9                       # wavelength [m]
rec_dis = 5.81e-3                   # Reconstruction distance [m]
# rec_dis = 50e-3
So_sc = 11.618e-3                       # L parameter in the microscope setup [m]
# So_sc = 20e-3
...
parameters = [holo,ref,So_sc-rec_dis,So_sc,in_width,wvl]
...
# xar = focusing.manual_focus('kreuzer_reconstruct',focus_params,1e-3,3e-3,11)
